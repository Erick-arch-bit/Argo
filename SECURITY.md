...
curl -sSLO https://github.com/Erick-arch-bit/Argo/releases/download/v1.2.0/argo-linux-amd64
curl -sSLO https://github.com/Erick-arch-bit/Argo/releases/download/v1.2.0/argo-linux-amd64.sha256
